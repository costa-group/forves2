...
Module SStackValCmpImplSoundness.
  ...
  Proof.
    ...
    - intros smemory_cmp sstorage_cmp sha3_cmp H_safe_smemory_cmp H_safe_sstorage_cmp H_safe_sha3_cmp.
      ...
      pose proof (follow_in_smap_suc sb1 sv1 maxidx1 ops H_valid_sv1 H_valid_sb1) as H_follow_suc_sv1.
      destruct H_follow_suc_sv1 as [smv1 [maxidx1' [sb1' [H_follow_suc_sv1 _]]]].
      pose proof (follow_in_smap_suc sb2 sv2 maxidx2 ops H_valid_sv2 H_valid_sb2) as H_follow_suc_sv2.
      ...
      pose proof (valid_follow_in_smap sb1 sv1 maxidx1 ops smv1 maxidx1' sb1' H_valid_sv1 H_valid_sb1 H_follow_suc_sv1) as H_follow_valid_sv1.
      ...
      + unfold safe_sha3_cmp_ext_d in H_safe_sha3_cmp.
        ...
        destruct (map_option (EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx1' sb1' ops)) smem) as [updates|] eqn:H_eval_smem_0; try discriminate.
        unfold eval_sstack_val in H_eval_smem_0.
        assert (H_maxidx1_ge_S_maxidx1': S maxidx1' <= maxidx1). intuition.
        pose proof (instantiate_memory_update_mapo_preserved_when_depth_ext_le smem (S maxidx1') maxidx1 model mem strg exts maxidx1' sb1' ops updates H_maxidx1_ge_S_maxidx1' H_eval_smem_0) as H_eval_smem_0_ext.
        rewrite H_eval_smem_0_ext.
        
        unfold eval_smemory in H_eval_smem0.
        destruct (map_option (EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx2' sb2' ops)) smem0) as [updates0|] eqn:H_eval_smem0_0; try discriminate.
        unfold eval_sstack_val in H_eval_smem0_0.
        assert (H_maxidx2_ge_S_maxidx2': S maxidx2' <= maxidx2). intuition.
        pose proof (instantiate_memory_update_mapo_preserved_when_depth_ext_le smem0 (S maxidx2') maxidx2 model mem strg exts maxidx2' sb2' ops updates0 H_maxidx2_ge_S_maxidx2' H_eval_smem0_0) as H_eval_smem0_0_ext.
        rewrite H_eval_smem0_0_ext.

        unfold eval_sstack_val in H_eval_offset.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' offset coffset model mem strg exts ops H_maxidx1_ge_S_maxidx1' H_eval_offset) as H_eval_offset_0.
        rewrite H_eval_offset_0.

        unfold eval_sstack_val in H_eval_size.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' size csize model mem strg exts ops H_maxidx1_ge_S_maxidx1' H_eval_size) as H_eval_size_0.
        rewrite H_eval_size_0.

        unfold eval_sstack_val in H_eval_offset0.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' offset0 coffset0 model mem strg exts ops H_maxidx2_ge_S_maxidx2' H_eval_offset0) as H_eval_offset0_0.
        rewrite H_eval_offset0_0.

        unfold eval_sstack_val in H_eval_size0.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' size0 csize0 model mem strg exts ops H_maxidx2_ge_S_maxidx2' H_eval_size0) as H_eval_size0_0.
    ...
    - intros smemory_cmp sstorage_cmp sha3_cmp H_safe_smemory_cmp H_safe_sstorage_cmp H_safe_sha3_cmp.
      ...
      + fold eval_sstack_val' in H_cmp_sv1_sv2. destruct (label =?i label0) eqn:E_eqb_label_label0; try discriminate.
        ...
        assert(H_fldr:
                forall args1 args2,
                  valid_sstack maxidx1' args1 ->
                  valid_sstack maxidx2' args2 ->
                  fold_right_two_lists (fun e1 e2 : sstack_val => basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx e1 e2 maxidx1' sb1' maxidx2' sb2' ops) args1 args2 = true ->
                  exists args',
                    map_option (fun sv' : sstack_val => eval_sstack_val' (S maxidx1') sv' model mem strg exts maxidx1' sb1' ops) args1 = Some args' /\
                      map_option (fun sv' : sstack_val => eval_sstack_val' (S maxidx2') sv' model mem strg exts maxidx2' sb2' ops) args2 = Some args').
        ...
        * induction args1 as [|a1_1 args1'].
          ...
          ** destruct args2 as [|a1_2 args2']; try discriminate.
             ...
             destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx a1_1 a1_2
                         maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_a1_1_a1_2; try discriminate.
        ...
        * destruct (fold_right_two_lists
                      (fun e1 e2 : sstack_val =>
                       basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx e1 e2 maxidx1' sb1' maxidx2' sb2'
                         ops) args args0) eqn:E_fldr.
          ** pose proof (H_fldr args args0 H_follow_valid_sv1_0_1 H_follow_valid_sv2_0_1 E_fldr) as H_fldr_0.
             ...
             pose proof (eval_sstack_val'_mapo_preserved_when_depth_ext_le args (S maxidx1') maxidx1 model mem strg exts maxidx1' sb1' ops args' H_maxidx1_ge_S_maxidx1' H_fldr_0_0) as H_fldr_0_0_0.
             rewrite H_fldr_0_0_0.

             assert (H_maxidx2_ge_S_maxidx2': maxidx2 >= S maxidx2'). intuition.
             pose proof (eval_sstack_val'_mapo_preserved_when_depth_ext_le args0 (S maxidx2') maxidx2 model mem strg exts maxidx2' sb2' ops args' H_maxidx2_ge_S_maxidx2' H_fldr_0_1) as H_fldr_0_1_0.
          ...
          ** destruct H_comm as [H_f_comm_proof|]; try discriminate.
             ...
             destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx a1 b2 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_a1_b2; try discriminate.
             ...
             pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' a1 v1 model mem strg exts ops H_Smaxidx1'_le_maxidx1 H_safe_sstack_value_cmp_a1) as H_safe_sstack_value_cmp_a1_ext.

             assert(H_Smaxidx2'_le_maxidx2: S maxidx2' <= maxidx2). intuition.
             pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' b2 v1 model mem strg exts ops H_Smaxidx2'_le_maxidx2 H_safe_sstack_value_cmp_b2) as H_safe_sstack_value_cmp_b2_ext.


             pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' a2 v2 model mem strg exts ops H_Smaxidx1'_le_maxidx1 H_safe_sstack_value_cmp_a2) as H_safe_sstack_value_cmp_a2_ext.

             pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' b1 v2 model mem strg exts ops H_Smaxidx2'_le_maxidx2 H_safe_sstack_value_cmp_b1) as H_safe_sstack_value_cmp_b1_ext.
             ...
             split; reflexivity.
      + destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_offset_offset0; try discriminate.
        ...
        assert (H_Smaxidx1'_le_maxidx1: S maxidx1' <= maxidx1). intuition.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' offset v model mem strg exts ops H_Smaxidx1'_le_maxidx1 H_eval_offset) as H_eval_soffset_ext.
        rewrite H_eval_soffset_ext.
        assert (H_Smaxidx2'_le_maxidx2: S maxidx2' <= maxidx2). intuition.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' offset0 v model mem strg exts ops H_Smaxidx2'_le_maxidx2 H_eval_offset0) as H_eval_soffset0_ext.
        ...
        destruct (map_option
                   (instantiate_memory_update
                      (fun sv : sstack_val =>
                       eval_sstack_val sv model mem strg exts maxidx1'
        ...
        destruct (map_option
                    (instantiate_memory_update
                       (fun sv : sstack_val =>
                        eval_sstack_val sv model mem strg exts maxidx2'
                          sb2' ops)) smem0) as [updates0|] eqn:E_mapo_mem0; try discriminate.
        unfold eval_sstack_val in E_mapo_mem0.

        pose proof (instantiate_memory_update_mapo_preserved_when_depth_ext_le smem (S maxidx1') maxidx1 model mem strg exts maxidx1' sb1' ops updates H_Smaxidx1'_le_maxidx1 E_mapo_mem) as E_mapo_mem_ext.
        rewrite E_mapo_mem_ext.
        
        pose proof (instantiate_memory_update_mapo_preserved_when_depth_ext_le smem0 (S maxidx2') maxidx2 model mem strg exts maxidx2' sb2' ops updates0 H_Smaxidx2'_le_maxidx2 E_mapo_mem0) as E_mapo_mem0_ext.
      ...
      + destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx key key0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_key_key0; try discriminate.
        ...
        assert (H_Smaxidx1'_le_maxidx1: S maxidx1' <= maxidx1). intuition.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' key v model mem strg exts ops H_Smaxidx1'_le_maxidx1 H_eval_key) as H_eval_skey_ext.
        rewrite H_eval_skey_ext.
        assert (H_Smaxidx2'_le_maxidx2: S maxidx2' <= maxidx2). intuition.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' key0 v model mem strg exts ops H_Smaxidx2'_le_maxidx2 H_eval_key0) as H_eval_skey0_ext.
        ...
        pose proof (instantiate_storage_update_mapo_preserved_when_depth_ext_le sstrg (S maxidx1') maxidx1 model mem strg exts maxidx1' sb1' ops updates H_Smaxidx1'_le_maxidx1 E_mapo_strg) as E_mapo_strg_ext.
        rewrite E_mapo_strg_ext.
        
        pose proof (instantiate_storage_update_mapo_preserved_when_depth_ext_le sstrg0 (S maxidx2') maxidx2 model mem strg exts maxidx2' sb2' ops updates0 H_Smaxidx2'_le_maxidx2 E_mapo_strg0) as E_mapo_strg0_ext.
      ...
      + assert(H_d'0_le_d': d'0 <= S d'). intuition.
        ...
        destruct (if
                     basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1'
                       maxidx2' sb2' ops
                    then
                     if
                      basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx size size0 maxidx1' sb1'
                        maxidx2' sb2' ops
                     then
                       smemory_cmp (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0) ctx smem smem0
                         maxidx1' sb1' maxidx2' sb2' ops
                     else false
                   else false) eqn:E_std_sha3.

        * destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_offset_offset0; try discriminate.
          destruct (basic_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d'0 ctx size size0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_size_size0; try discriminate.
        ...
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx1') maxidx1 maxidx1' sb1' size v' model mem strg exts ops H_Smaxidx1'_le_maxidx1 H_eval_size) as H_eval_ssize_ext.
        rewrite H_eval_ssize_ext.
        pose proof (eval_sstack_val'_preserved_when_depth_extended_le (S maxidx2') maxidx2 maxidx2' sb2' size0 v' model mem strg exts ops H_Smaxidx2'_le_maxidx2 H_eval_size0) as H_eval_ssize0_ext.
        ...
        rewrite H_eval_mem0.
        rewrite H_eval_mem.
        exists (get_sha3_info_op (get_keccak256_exts exts) (wordToNat v') (concrete_interpreter.ConcreteInterpreter.mload' mem' v (wordToNat v'))).
        split; reflexivity.
        * unfold safe_sha3_cmp_ext_d in H_safe_sha3_cmp.
          unfold safe_sha3_cmp in H_safe_sha3_cmp.
  ...
  Proof.
    ...
    - intros smemory_cmp sstorage_cmp sha3_cmp H_safe_smemory_cmp H_safe_sstorage_cmp H_safe_sha3_cmp.
      ...
      destruct(trivial_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp 1 ctx sv1 sv2 maxidx1 sb1 maxidx2 sb2 ops) eqn:E_trivial_chk.
      ...
      destruct sv1 as [w1 | n1 | n1]; destruct sv2 as [w2 | n2 | n2] eqn:E_sv2; try discriminate.
        ...
        pose proof (eval_sstack_val'_Val w1 model mem strg exts maxidx1 sb1 ops) as H_eval_w1.
        pose proof (eval_sstack_val'_Val w2 model mem strg exts maxidx2 sb2 ops) as H_eval_w2.
        rewrite H_eval_w1.
        rewrite H_eval_w2.
        ...
        (* InVar *)
        pose proof (eval_sstack_val'_InVar n1 model mem strg exts maxidx1 sb1 ops) as H_eval_instkv_n1.
        pose proof (eval_sstack_val'_InVar n2 model mem strg exts maxidx2 sb2 ops) as H_eval_instkv_n2.
        rewrite H_eval_instkv_n1.
        rewrite H_eval_instkv_n2.
        
        apply Nat.eqb_eq in E_trivial_chk.
        ...
        pose proof (eval_sstack_val'_succ (S maxidx2) (FreshVar n2) model mem strg exts maxidx2 sb2 ops H_valid_sv2 H_valid_sb2 (gt_Sn_n maxidx2)) as H_eval_sv2.
        destruct H_eval_sv2 as [v2 H_eval_sv2].
    ...
    - intros smemory_cmp sstorage_cmp sha3_cmp H_safe_smemory_cmp H_safe_sstorage_cmp H_safe_sha3_cmp.
      ...
      + fold eval_sstack_val' in H_cmp_sv1_sv2. destruct (label =?i label0) eqn:E_eqb_label_label0; try discriminate.
        ...
        assert(H_fldr:
                forall args1 args2,
                  valid_sstack maxidx1' args1 ->
                  valid_sstack maxidx2' args2 ->
                  fold_right_two_lists (fun e1 e2 : sstack_val => basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx e1 e2 maxidx1' sb1' maxidx2' sb2' ops) args1 args2 = true ->
                  exists args',
                    map_option (fun sv' : sstack_val => eval_sstack_val' (S maxidx1') sv' model mem strg exts maxidx1' sb1' ops) args1 = Some args' /\
                      map_option (fun sv' : sstack_val => eval_sstack_val' (S maxidx2') sv' model mem strg exts maxidx2' sb2' ops) args2 = Some args').
        (* staring proof of assert *)
        * induction args1 as [|a1_1 args1'].
          ...
          ** destruct args2 as [|a1_2 args2']; try discriminate.
             ...
             unfold fold_right_two_lists in H_fldr.
             rewrite <- fold_right_two_lists_ho in H_fldr.
             destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx a1_1 a1_2
                         maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_a1_1_a1_2; try discriminate.
             simpl in H_valid_sstack_args1.
             destruct H_valid_sstack_args1 as [H_valid_a1_1 H_valid_arg1'].
             simpl in H_valid_sstack_args2.
        ...
        * destruct (fold_right_two_lists
                      (fun e1 e2 : sstack_val =>
                       basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx e1 e2 maxidx1' sb1' maxidx2' sb2'
                         ops) args args0) eqn:E_fldr.
          ** pose proof (H_fldr args args0 H_follow_valid_sv1_0_1 H_follow_valid_sv2_0_1 E_fldr) as H_fldr_0.
             destruct H_fldr_0 as [args' [H_fldr_0_0 H_fldr_0_1]].
          ...
          ** destruct H_comm as [H_f_comm_proof|]; try discriminate.
             ...
             destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx a1 b2 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_a1_b2; try discriminate.
             ...
             rewrite H_f_comm_proof.
             split; reflexivity.
      + destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_offset_offset0; try discriminate.
      ...
      + destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx key key0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_key_key0; try discriminate.
      ...
      + assert(H_d'0_le_d': d'0 <= S d'). intuition.
        ...
        destruct (if
                     basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1'
                       maxidx2' sb2' ops
                    then
                     if
                      basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx size size0 maxidx1' sb1'
                        maxidx2' sb2' ops
                     then
                       smemory_cmp (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0) ctx smem smem0
                         maxidx1' sb1' maxidx2' sb2' ops
                     else false
                   else false) eqn:E_std_sha3.

        * destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx offset offset0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_offset_offset0; try discriminate.
          destruct (basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d'0 ctx size size0 maxidx1' sb1' maxidx2' sb2' ops) eqn:E_cmp_size_size0; try discriminate.
