...
Definition st_is_instance_of_sst (st: state) (model: assignment) (sst: sstate) (ops: stack_op_instr_map) : Prop :=
  exists mem strg exts st',
...
Definition snd_state_transformer ( tr : state -> stack_op_instr_map -> option state ) (symtr : constraints -> sstate ->  stack_op_instr_map -> option sstate )  : Prop :=
  forall (ctx: constraints) (sst sst': sstate) (ops : stack_op_instr_map),
    ...
    valid_sstate sst' ops /\
      forall (st: state) (model: assignment),
        is_model ctx model = true ->
        st_is_instance_of_sst st model sst ops ->
        exists (st': state),
          tr st ops = Some st' /\ st_is_instance_of_sst st' model sst' ops.
...
Lemma st_is_instance_of_sst_stk_len:
  forall (st: state) (model: assignment) (sst: sstate) (ops: stack_op_instr_map),
         st_is_instance_of_sst st model sst ops ->
         length (get_stack_sst sst) = length (get_stack_st st).
Proof.
  intros st model sst ops H_inst.
  unfold st_is_instance_of_sst in H_inst.
  destruct H_inst as [mem [strg [exts [st' H_inst]]]].
...
Proof.
  ...
  + simpl in H_eval_sstack.
    ...
    * destruct (ops label) eqn:E_label; try discriminate.
      ...
      destruct (map_option (fun sv' : sstack_val => eval_sstack_val' maxidx sv' model mem strg exts key sb0 ops) args) eqn:E_mapo_args; try discriminate.
    ...
    (* proof of assert *)
      ** induction args0 as [|a args0' IHargs0'].
         ...
         *** intros d maxidx0 sb1 l0 H_mapo.
             simpl in H_mapo.
             destruct (eval_sstack_val' d a model mem strg exts maxidx0 sb1 ops) eqn:E_eval_sstack_val'; try discriminate.
             destruct (map_option (fun sv' : sstack_val => eval_sstack_val' d sv' model mem strg exts maxidx0 sb1 ops) args0') eqn:E_mapo'; try discriminate.
        pose proof (IHargs0' d maxidx0 sb1 l1 E_mapo') as IHargs'_0.
        pose proof (eval_sstack_val'_preserved_when_depth_extended d maxidx0 sb1 a e model mem strg exts ops E_eval_sstack_val') as H_eval_sstack_val'_preserved_when_depth_extended_0.
        unfold map_option.
        rewrite <- map_option_ho.
    ...
    * assert(H_mapo_mem :
            ...
            ** induction args as [|a args' IHargs'].
               ...
               *** intros d maxidx0 sb1 l H_mapo_mem.
                   ...
                   **** destruct (eval_sstack_val' d offset0 model mem strg exts maxidx0 sb1 ops) eqn:E_offset0; try discriminate.
                        ...
                        pose proof (eval_sstack_val'_preserved_when_depth_extended d maxidx0 sb1 offset0 e model mem strg exts ops E_offset0) as H_eval_sstack_val'_preserved_when_depth_extended_0.
                        pose proof (eval_sstack_val'_preserved_when_depth_extended d maxidx0 sb1 value e0 model mem strg exts ops E_value) as H_eval_sstack_val'_preserved_when_depth_extended_1.
            ...
            ** destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' maxidx sv model mem strg exts key sb0 ops)) smem) eqn:E_mapo_smem; try discriminate.
               destruct (eval_sstack_val' maxidx offset model mem strg exts key sb0 ops) eqn:E_eval_offset; try discriminate.
               pose proof (H_mapo_mem smem maxidx key sb0 l E_mapo_smem) as H_mapo_smem_0.
               rewrite H_mapo_smem_0.
               pose proof (eval_sstack_val'_preserved_when_depth_extended maxidx key sb0 offset e model mem strg exts ops E_eval_offset) as H_eval_sstack_val'_preserved_when_depth_extended_0.
               rewrite H_eval_sstack_val'_preserved_when_depth_extended_0.
               apply H_eval_sstack.
    ...
    * assert(H_mapo_strg :
            ...
            ** induction args as [|a args' IHargs'].
               ...
               *** intros d maxidx0 sb1 l H_mapo_strg.
                   ...
                   destruct (eval_sstack_val' d skey model mem strg exts maxidx0 sb1 ops) eqn:E_skey; try discriminate.
                   destruct (eval_sstack_val' d svalue model mem strg exts maxidx0 sb1 ops) eqn:E_svalue; try discriminate.
                   ...
                   pose proof (eval_sstack_val'_preserved_when_depth_extended d maxidx0 sb1 skey e model mem strg exts ops E_skey) as H_eval_sstack_val'_preserved_when_depth_extended_0.
                   pose proof (eval_sstack_val'_preserved_when_depth_extended d maxidx0 sb1 svalue e0 model mem strg exts ops E_svalue) as H_eval_sstack_val'_preserved_when_depth_extended_1.
                   pose proof (IHargs' d maxidx0 sb1 l0 E_mapo_args') as IHargs'_0.
                   unfold map_option.
                   rewrite <- map_option_ho.
            ...
            ** destruct (map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val' maxidx sv model mem strg exts key sb0 ops)) sstrg) eqn:E_mapo_sstrg; try discriminate.
               destruct (eval_sstack_val' maxidx key0 model mem strg exts key sb0 ops) eqn:E_eval_skey0; try discriminate.
               pose proof (H_mapo_strg sstrg maxidx key sb0 l E_mapo_sstrg) as H_mapo_sstrg_0.
               rewrite H_mapo_sstrg_0.
               pose proof (eval_sstack_val'_preserved_when_depth_extended maxidx key sb0 key0 e model mem strg exts ops E_eval_skey0) as H_eval_sstack_val'_preserved_when_depth_extended_0.
               rewrite H_eval_sstack_val'_preserved_when_depth_extended_0.
               apply H_eval_sstack.
    ...
    * assert(H_mapo_mem :
            ...
            ** destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' maxidx sv model mem strg exts key sb0 ops)) smem) eqn:E_mapo_smem; try discriminate.
               destruct (eval_sstack_val' maxidx offset model mem strg exts key sb0 ops) eqn:E_eval_offset; try discriminate.
               destruct (eval_sstack_val' maxidx size model mem strg exts key sb0 ops) eqn:E_eval_size; try discriminate.
               pose proof (H_mapo_mem smem maxidx key sb0 l E_mapo_smem) as H_mapo_smem_0.
               rewrite H_mapo_smem_0.
               pose proof (eval_sstack_val'_preserved_when_depth_extended maxidx key sb0 offset e model mem strg exts ops E_eval_offset) as H_eval_sstack_val'_preserved_when_depth_extended_0.
               rewrite H_eval_sstack_val'_preserved_when_depth_extended_0.
               pose proof (eval_sstack_val'_preserved_when_depth_extended maxidx key sb0 size e0 model mem strg exts ops E_eval_size) as H_eval_sstack_val'_preserved_when_depth_extended_1.
               rewrite H_eval_sstack_val'_preserved_when_depth_extended_1.
               apply H_eval_sstack.
Qed.
...
Lemma eval_sstack_val_preserved_when_smap_extended:
  forall m m' sv smv v model mem strg exts ops idx',
    valid_sstack_value (get_maxidx_smap m)  sv ->
    (add_to_smap m smv) = (idx', m') ->
    eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops = Some v ->
    eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops = Some v.
Proof.
  unfold eval_sstack_val.
...
Lemma eval_sstack_mapo_preserved_when_smap_extended:
  forall sstk m m' smv stk' model mem strg exts ops idx',
    valid_sstack (get_maxidx_smap m) sstk ->
    (add_to_smap m smv) = (idx', m') ->
    map_option (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) sstk = Some stk' ->
    map_option (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops) sstk = Some stk'.
Proof.
  
  induction sstk as [|sv sstk' IHsstk'].
  
  - intros m m' smv stk' model mem strg exts ops idx' H_valid_sstk H_add_to_smap H_mapo.
    simpl.
    simpl in H_mapo.
    rewrite <- H_mapo.
    reflexivity.
  - intros m m' smv stk' model mem strg exts ops idx' H_valid_sstk H_add_to_smap H_mapo.
    ...
    destruct (eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [v|] eqn:E_eval_sstack_value_sv; try discriminate.

    simpl in H_valid_sstk.
    destruct H_valid_sstk as [H_valid_sv H_valid_sstk'].
    pose proof (eval_sstack_val_preserved_when_smap_extended m m' sv smv v model mem strg exts ops idx' H_valid_sv H_add_to_smap E_eval_sstack_value_sv) as H_eval_sv_preserved.

    destruct (map_option (fun elem : sstack_val => eval_sstack_val elem model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) sstk') as [stk''|] eqn:E_mapo_sstk'; try discriminate.

    pose proof (IHsstk' m m' smv stk'' model mem strg exts ops idx' H_valid_sstk' H_add_to_smap E_mapo_sstk') as H_eval_sstk'_preserved.
    simpl.
...
Lemma eval_sstack_preserved_when_smap_extended:
  forall sstk m m' smv stk' model mem strg exts ops idx',
    valid_sstack (get_maxidx_smap m) sstk ->
    (add_to_smap m smv) = (idx', m') ->
    eval_sstack sstk (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts  ops = Some stk' ->
    eval_sstack sstk (get_maxidx_smap m') (get_bindings_smap m') model mem strg exts ops = Some stk'.
Proof.
  unfold eval_sstack.
...
Lemma eval_smemory_update_preserved_when_smap_extended:
  forall u m m' uv smv model mem strg exts ops idx',
    valid_smemory_update (get_maxidx_smap m) u ->
    (add_to_smap m smv) = (idx', m') ->
    eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) u = Some uv -> 
    eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops) u = Some uv.
Proof.
  intros u m m' uv smv model mem strg exts ops idx' H_valid_u H_add_to_smap H_eval_u.

  destruct u as [soffset svalue|soffset svalue] eqn:E_u.

  - simpl in H_eval_u.
    destruct (eval_sstack_val soffset model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [offset|] eqn:E_eval_soffset; try discriminate.
    destruct (eval_sstack_val svalue model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [value|] eqn:E_eval_svalue; try discriminate.

    simpl in H_valid_u.
    destruct H_valid_u as [H_valid_soffset H_valid_svalue].

    pose proof (eval_sstack_val_preserved_when_smap_extended m m' soffset smv offset model mem strg exts ops idx' H_valid_soffset H_add_to_smap E_eval_soffset) as H_eval_soffset_preserved.

    pose proof (eval_sstack_val_preserved_when_smap_extended m m' svalue smv value model mem strg exts ops idx' H_valid_svalue H_add_to_smap E_eval_svalue) as H_eval_svalue_preserved.
...
Lemma eval_smemory_mapo_preserved_when_smap_extended:
  forall smem m m' smv us model mem strg exts ops idx',
    valid_smemory (get_maxidx_smap m) smem ->
    (add_to_smap m smv) = (idx', m') ->
    map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem = Some us ->
    map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv => eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops)) smem = Some us.
Proof.
  
  induction smem as [|u smem' IHsmem'].

  - intros m m' smv us model mem strg exts ops idx' H_valid_smem H_add_to_smap H_mapo_smem.
    simpl.
  ...
  - intros m m' smv us model mem strg exts ops idx' H_valid_smem H_add_to_smap H_mapo_smem.
    ...
    destruct (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) u) as [elem_val|] eqn:E_eval_u; try discriminate.

    simpl in H_valid_smem.
    destruct H_valid_smem as [H_valid_u H_valid_smem'].

    pose proof (eval_smemory_update_preserved_when_smap_extended u m m' elem_val smv model mem strg exts ops idx' H_valid_u H_add_to_smap E_eval_u) as H_eval_u_preserved.

    destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem') as [rs_val|] eqn:E_smem'; try discriminate.

    pose proof (IHsmem' m m' smv rs_val model mem strg exts ops idx'  H_valid_smem' H_add_to_smap E_smem') as H_eval_smem'_preserved.
...
Lemma eval_smemory_preserved_when_smap_extended:
  forall smem m m' smv mem' model mem strg exts ops idx',
    valid_smemory (get_maxidx_smap m) smem ->
    (add_to_smap m smv) = (idx', m') ->
    eval_smemory smem (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops = Some mem' ->
    eval_smemory smem (get_maxidx_smap m') (get_bindings_smap m') model mem strg exts ops = Some mem'.
Proof.
  intros smem m m' smv mem' model mem strg exts ops idx' H_valid_smemory H_add_to_smap H_eval_smemory.

  unfold eval_smemory in H_eval_smemory.
  destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem) as [updates|] eqn:E_mapo_smem; try discriminate.

  pose proof (eval_smemory_mapo_preserved_when_smap_extended smem m m' smv updates model mem strg exts ops idx' H_valid_smemory H_add_to_smap E_mapo_smem) as H_mapo_smem_preserved.
...
Lemma eval_sstorage_update_preserved_when_smap_extended:
  forall u m m' uv smv model mem strg exts ops idx',
    valid_sstorage_update (get_maxidx_smap m) u ->
    (add_to_smap m smv) = (idx', m') ->
    eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) u = Some uv -> 
    eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops) u = Some uv.
Proof.
  intros u m m' uv smv model mem strg exts ops idx' H_valid_u H_add_to_smap H_eval_u.
  ...
  simpl in H_eval_u.
  destruct (eval_sstack_val skey model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [key|] eqn:E_eval_skey; try discriminate.
  destruct (eval_sstack_val svalue model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [value|] eqn:E_eval_svalue; try discriminate.
  
  simpl in H_valid_u.
  destruct H_valid_u as [H_valid_skey H_valid_svalue].
  
  pose proof (eval_sstack_val_preserved_when_smap_extended m m' skey smv key model mem strg exts ops idx' H_valid_skey H_add_to_smap E_eval_skey) as H_eval_skey_preserved.
...
Lemma eval_sstorage_mapo_preserved_when_smap_extended:
  forall sstrg m m' smv us model mem strg exts ops idx',
    valid_sstorage (get_maxidx_smap m) sstrg ->
    (add_to_smap m smv) = (idx', m') ->
    map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) sstrg = Some us ->
    map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv => eval_sstack_val sv model mem strg exts (get_maxidx_smap m') (get_bindings_smap m') ops)) sstrg = Some us.
Proof.
  
  induction sstrg as [|u sstrg' IHsstrg'].

  - intros m m' smv us model mem strg exts ops idx' H_valid_sstrg H_add_to_smap H_mapo_sstrg.
    simpl.
  ...
  - intros m m' smv us model mem strg exts ops idx' H_valid_sstrg H_add_to_smap H_mapo_sstrg.
    ...
    destruct (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) u) as [elem_val|] eqn:E_eval_u; try discriminate.

    simpl in H_valid_sstrg.
    destruct H_valid_sstrg as [H_valid_u H_valid_sstrg'].

    pose proof (eval_sstorage_update_preserved_when_smap_extended u m m' elem_val smv model mem strg exts ops idx' H_valid_u H_add_to_smap E_eval_u) as H_eval_u_preserved.

    destruct (map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) sstrg') as [rs_val|] eqn:E_sstrg'; try discriminate.

    pose proof (IHsstrg' m m' smv rs_val model mem strg exts ops idx'  H_valid_sstrg' H_add_to_smap E_sstrg') as H_eval_sstrg'_preserved.
...
Lemma eval_sstorage_preserved_when_smap_extended:
  forall sstrg m m' smv mem' model mem strg exts ops idx',
    valid_sstorage (get_maxidx_smap m) sstrg ->
    (add_to_smap m smv) = (idx', m') ->
    eval_sstorage sstrg (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts  ops = Some mem' ->
    eval_sstorage sstrg (get_maxidx_smap m') (get_bindings_smap m') model mem strg exts ops = Some mem'.
Proof.
  intros sstrg m m' smv mem' model mem strg exts ops idx' H_valid_sstorage H_add_to_smap H_eval_sstorage.

  unfold eval_sstorage in H_eval_sstorage.
  destruct (map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) sstrg) as [updates|] eqn:E_mapo_sstrg; try discriminate.

  pose proof (eval_sstorage_mapo_preserved_when_smap_extended sstrg m m' smv updates model mem strg exts ops idx' H_valid_sstorage H_add_to_smap E_mapo_sstrg) as H_mapo_sstrg_preserved.
...
Proof.
  ...
  - intros st model H_is_model H_st_inst_sst.
    pose proof (st_is_instance_of_sst_stk_len st model sst ops H_st_inst_sst) as H_inst_stk_len.
(*    destruct H_inst_stk_len as [H_inst_stk_len_l H_inst_stk_len_r]. *)
    ...
    + injection H_push_s as H_sst'.
      ...
      exists mem. exists strg. exists exts. exists (set_stack_st st' (w::(get_stack_st st'))).
      split.
      ++ pose proof (eval_sstate_w model w sst st' mem strg exts ops H_st_inst_sst_l) as H_eval_sstate_w.
...
Proof.
  ...
  - intros st model H_is_model H_st_inst_sst.
    ...
    unfold st_is_instance_of_sst in H_st_inst_sst'.
    destruct H_st_inst_sst' as [mem [strg [exts [st' [H_st_inst_sst'_l H_st_inst_sst'_r]]]]].

    unfold st_is_instance_of_sst.
    exists mem. exists strg. exists exts. exists (set_stack_st st (get_tags_exts (get_externals_st st) cat v :: get_stack_st st)).
    ...
    pose proof (eval_smemory_preserved_when_smap_extended (get_memory_sst sst) (get_smap_sst sst) sm' (SymMETAPUSH cat v) mem' model mem strg exts ops key' H_valid_sst_smemory E_add_to_smap E_eval_smemory) as H_eval_smem_preserved.
    rewrite H_eval_smem_preserved.

    (* equivalence of eval_sstorage *)
    pose proof (eval_sstorage_preserved_when_smap_extended (get_storage_sst sst) (get_smap_sst sst) sm' (SymMETAPUSH cat v) strg' model mem strg exts ops key' H_valid_sst_sstorage E_add_to_smap E_eval_sstorage) as H_eval_sstrg_preserved.
    rewrite H_eval_sstrg_preserved.

    (* the case of eval_sstack *)
    
    apply Nat.eqb_eq in H_inst_stk_len as H_inst_stk_len_eqb.
    ...
    pose proof (eval_sstack_preserved_when_smap_extended (get_stack_sst sst) (SymMap maxid sb) (SymMap maxid' sb') (SymMETAPUSH cat v) stk'' model mem strg exts ops key' H_valid_sst_sstack E_add_to_smap E_eval_sstack) as H_eval_sstack_preserved.
...
Proof.
  ...
  destruct H as [mem [strg [exts [st' H]]]].
  destruct H.
  ...
  destruct (eval_sstack_val s model mem strg exts maxid map0 ops) in H; try discriminate.
  destruct (eval_sstack s0 maxid map0 model mem strg exts ops) in H; try discriminate.
  destruct (eval_smemory (get_memory_sst sst) maxid map0 model mem strg exts ops) in H; try discriminate.
  destruct (eval_sstorage (get_storage_sst sst) maxid map0 model mem strg exts ops) in H; try discriminate.
  unfold make_st in H.
  injection H. intros.
...
Lemma eval_sstate_stack_tl:
  forall sst st v1 v2 l l' model mem strg exts ops,
  get_stack_sst sst = v1 :: l ->
  get_stack_st st = v2 :: l' ->
  eval_sstate sst model mem strg exts ops = Some st ->
  eval_sstate (set_stack_sst sst l) model mem strg exts ops = Some (set_stack_st st l').
Proof.
  intros.
  ...
  destruct (map_option (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx bs ops) (v1 :: l)) as [stk|] eqn:E_mapo; try discriminate.

  destruct (eval_smemory (get_memory_sst sst) maxidx bs model mem strg exts ops) as [mem'|] eqn:E_mem; try discriminate.

  destruct (eval_sstorage (get_storage_sst sst) maxidx bs model mem strg exts ops) as [srtg'|] eqn:E_strg; try discriminate.
...
Proof.
  ...
  - intros st model H_is_model H_st_inst_sst. 
    ...
    pose proof (pop_succ model st sst ops l  H_st_inst_sst H_pop_sst) as H_pop_succ.
    ...
    + injection  H_pop_s as  H_sst'.
      rewrite <- H_sst'.
      unfold st_is_instance_of_sst in H_st_inst_sst.
      destruct H_st_inst_sst as [mem [strg [exts [st' [H_st_inst_sst_l H_st_inst_sst_r]]]]].
      pose proof (eq_execution_states_ext st st'  H_st_inst_sst_r) as H_eq_st_st'.
      rewrite <- H_eq_st_st' in H_st_inst_sst_l.
      
      pose proof (eval_sstate_stack_tl sst st v1 v2 l l' model mem strg exts ops H_pop_succ_l H_pop_succ_r H_st_inst_sst_l).
