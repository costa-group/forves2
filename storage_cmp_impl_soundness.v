...
Module StorageCmpImplSoundness.
  ...
  Proof.
    ...
    + intros sstrg2 H_valid_sstrg1 H_valid_sstrg2 H_basic_strg_smp model mem strg exts H_is_model.
    ...
    + intros sstrg2 H_valid_sstrg1 H_valid_sstrg2 H_basic_strg_smp model mem strg exts H_is_model.
      ...
      ++ simpl in H_basic_strg_smp.
         ...
         destruct (sstack_val_cmp d' ctx skey1 skey2 maxidx1 sb1 maxidx2 sb2 ops) eqn:E_cmp_skey1_skey2; try discriminate.
         ...
         pose proof (IHsstrg1' sstrg2' H_valid_sstrg1' H_valid_sstrg2' H_basic_strg_smp model mem strg exts H_is_model) as IHsstrg1'_0.
         ...
         destruct (map_option (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx1 sb1 ops)) sstrg1') as [updates1|] eqn:H_mo_sstrg1'; try discriminate.
         injection IHsstrg1'_0 as IHsstrg1'_0.
         
         unfold eval_sstorage in IHsstrg1'_1.
         destruct (map_option (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx2 sb2 ops)) sstrg2') as [updates2|] eqn:H_mo_sstrg2'; try discriminate.
...
Qed.
    ...
    + intros sstrg b sstrg_r H_valid_sstrg H_reorder'.
      ...
      ++  destruct sstrg' as [|u2 sstrg''] eqn:H_sstrg'.
          +++ injection H_reorder' as H_b H_sstrg_r.
              ...
              split; try auto.
              apply H_valid_sstrg.
          +++ destruct (swap_storage_update ctx u1 u2 maxidx sb) eqn:E_swap.
              ++++ destruct (reorder_updates' d'' ctx (u1 :: sstrg'')) eqn:E_reorder'_rec.
                   injection H_reorder' as H_b H_sstrg_r.
                   rewrite <- H_sstrg_r.
                   simpl in H_valid_sstrg.
                   destruct H_valid_sstrg as [H_valid_u1 [H_valid_u2 H_valid_sstrg'']].
                   pose proof (IHd' (u1 :: sstrg'') b0 s (valid_sstorage_when_extended_with_valid_update maxidx u1 sstrg'' H_valid_u1 H_valid_sstrg'') E_reorder'_rec) as IHd'_0.
                   simpl.
                   split.
                   +++++ apply H_valid_u2.
                   +++++ apply IHd'_0.
              ++++ destruct (reorder_updates' d'' ctx (u2 :: sstrg'')) eqn:E_reorder'_rec.
                   injection H_reorder' as H_b H_sstrg_r.
                   rewrite <- H_sstrg_r.
                   simpl in H_valid_sstrg.
                   destruct H_valid_sstrg as [H_valid_u1 [H_valid_u2 H_valid_sstrg'']].
                   pose proof (IHd' (u2 :: sstrg'') b0 s (valid_sstorage_when_extended_with_valid_update maxidx u2 sstrg'' H_valid_u2 H_valid_sstrg'') E_reorder'_rec) as IHd'_0.
                   simpl.
                   split.
                   +++++ apply H_valid_u1.
                   +++++ apply IHd'_0.
  ...
  Proof.
    ...
    + intros sstrg b sstrg_r H_valid_sstrg H_reorder'.
      ...
      injection H_reorder' as H_b H_sstrg_r.
      rewrite <- H_sstrg_r.
      pose proof (eval_sstorage_succ maxidx sb model mem strg exts ops sstrg H_valid_sstrg H_valid_sb) as H_eval_sstrg.
      destruct H_eval_sstrg as [strg' H_eval_sstrg].
      exists strg'.
    ...
    + intros sstrg b sstrg_r H_valid_sstrg H_reorder'.
      ...
      ++ destruct sstrg' as [|u2 sstrg''] eqn:E_sstrg'.
         +++ injection H_reorder' as H_b H_sstrg_r.
             ...
             pose proof (eval_sstack_val'_succ (S maxidx) skey1 model mem strg exts maxidx sb ops H_valid_skey1 H_valid_sb (gt_Sn_n maxidx)) as E_eval_skey1.
             ...
             split; reflexivity.
         +++ destruct (swap_storage_update ctx u1 u2 maxidx sb) eqn:E_swap.
             ++++ destruct (reorder_updates' d' ctx (u1 :: sstrg'') maxidx sb) as [b' sstrg_r'] eqn:E_reorder'_rec.
		  ...
		  rewrite <- H_eval_u2_u1_sstrg'' in H_eval_u1_u2_sstrg''.
                  ...
                  pose proof (IHd' (u1 :: sstrg'') b' sstrg_r' (valid_sstorage_when_extended_with_valid_update maxidx u1 sstrg'' H_valid_u1 H_valid_sstrg'') E_reorder'_rec model mem strg exts H_is_model) as IHd'_0.
                  destruct IHd'_0 as [strg' [H_eval_u1_sstrg'' H_eval_sstrg_r']].
                  rewrite <- E_sstrg_r.
                  
                  unfold eval_sstorage in H_eval_u1_sstrg''.
                  destruct (map_option (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx sb ops)) (u1 :: sstrg'')) as [updates1|] eqn:E_mo_1; try discriminate.
                  
                  unfold eval_sstorage in H_eval_sstrg_r'.
                  destruct (map_option (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx sb ops)) sstrg_r') as [updates2|] eqn:E_mo_2; try discriminate.
                  
                  destruct u2 as [skey2 svalue2] eqn:E_u2.
                  simpl in H_valid_u2.
                  destruct H_valid_u2 as [H_valid_skey2 H_valid_svalue2].

                  pose proof (eval_sstack_val'_succ (S maxidx) skey2 model mem strg exts maxidx sb ops H_valid_skey2 H_valid_sb (gt_Sn_n maxidx)) as E_eval_skey2.
                  ...
                  destruct (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx sb ops) u1) as [elem_val|] eqn:E_elem_val; try discriminate.
             ...
             ++++ destruct (reorder_updates' d' ctx (u2 :: sstrg'') maxidx sb) as [b' sstrg_r'] eqn:E_reorder'_rec.
                  simpl in H_valid_sstrg.
                  destruct H_valid_sstrg as [H_valid_u1 [H_valid_u2 H_valid_sstrg'']].

                  pose proof (IHd' (u2 :: sstrg'') b' sstrg_r' (valid_sstorage_when_extended_with_valid_update maxidx u2 sstrg'' H_valid_u2 H_valid_sstrg'') E_reorder'_rec model mem strg exts H_is_model) as IHd'_0.
                  destruct IHd'_0 as [strg' [H_eval_u2_sstrg'' H_eval_sstrg_r']].
                  injection H_reorder' as H_b' H_sstrg_r'.
                  rewrite <- H_sstrg_r'.

                  unfold eval_sstorage in H_eval_u2_sstrg''.
                  destruct (map_option (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx sb ops)) (u2 :: sstrg'')) as [updates1|] eqn:E_mo_1; try discriminate.
                  ...
                  unfold map_option in E_mo_1.
                  destruct (instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts maxidx sb ops) u2) as [elem_val|] eqn:E_elem_val; try discriminate.
  ...
  Proof.
    ...
    + intros n sstrg sstrg_r H_valid_sstrg H_reorder.
      ...
      destruct (reorder_updates' n ctx sstrg maxidx sb) as [changed sstrg'] eqn:E_reorder_update'.
      pose proof (reorder_updates'_valid ctx maxidx sb ops H_valid_sb n sstrg changed sstrg' H_valid_sstrg E_reorder_update') as H_valid_sstrg'.
      destruct changed.
...
Qed.
  ...
  Proof.
    ...
    + intros n sstrg sstrg' H_valid_sstrg H_reorder stk mem strg exts H_is_model.
      simpl in H_reorder.
      rewrite <- H_reorder.
      pose proof (eval_sstorage_succ maxidx sb stk mem strg exts ops sstrg H_valid_sstrg H_valid_sb) as H_eval_sstrg.
      destruct H_eval_sstrg as [strg' H_eval_sstrg].
      exists strg'.
      split; apply H_eval_sstrg.
    + intros n sstrg sstrg' H_valid_sstrg H_reorder stk mem strg exts H_is_model.
      ...
      ++ pose proof (reorder_updates'_valid ctx maxidx sb ops H_valid_sb n sstrg true sstrg_r H_valid_sstrg E_reorder_updates') as H_valid_sstrg_r.

         pose proof (IHd' n sstrg_r sstrg' H_valid_sstrg_r H_reorder stk mem strg exts H_is_model) as IHd'_0.
