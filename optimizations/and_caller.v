...
match val with
| SymOp AND [arg1;arg2] => 
  if is_caller_mask arg1 arg2 fcmp maxid sb ops ctx ||
     is_caller_mask arg2 arg1 fcmp maxid sb ops ctx 
...
destruct (is_caller_mask arg1 arg2 fcmp n sb evm_stack_opm ctx || 
          is_caller_mask arg2 arg1 fcmp n sb evm_stack_opm ctx) 
...
- destruct (is_caller_mask arg2 arg1 fcmp n sb evm_stack_opm) 
...
- (* evaluation is preserved *) 
  ...
  destruct r1 as [|arg2 r2]; try inject_rw Hoptm_sbinding eq_val'.
  destruct r2; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_caller_mask arg1 arg2 fcmp idx sb evm_stack_opm ctx
         || is_caller_mask arg2 arg1 fcmp idx sb evm_stack_opm ctx)
    eqn: eq_is_caller; try inject_rw Hoptm_sbinding eq_val'.
  unfold orb in eq_is_caller.
  destruct (is_caller_mask arg1 arg2 fcmp idx sb evm_stack_opm)
    eqn: is_caller_arg1_arg2.
  + unfold is_caller_mask in is_caller_arg1_arg2.
