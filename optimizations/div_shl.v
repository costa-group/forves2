...
match val with
| SymOp DIV [x; arg2] => 
  match is_shl_1 arg2 fcmp maxid sb ops ctx with
...
- (* evaluation is preserved *) 
  ...
  pose proof (eval_eq_prefix idx idx' sb sb' evm_stack_opm onev
    model mem strg ext (S idx) maxidx' prefix WOne onev_v Hvalid_sb idx_gt_idx'
