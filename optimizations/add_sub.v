...
| Some (FollowSmapVal (SymOp SUB [arg1; arg2]) idx' sb') => 
    if fcmp ctx arg2 x maxid sb maxid sb  ops
    then Some arg1
    else None
| _ => None
end.
...
- injection Hoptm_sbinding as eq_val' _.
  ...
  destruct (fcmp ctx x arg2 n sb n sb  evm_stack_opm) eqn: fcmp_x_arg2;
    try discriminate.
...
- destruct (is_sub_x arg2 arg1 fcmp n  sb evm_stack_opm) as [y|] 
  ...
  destruct r2 as [|x r2']; try discriminate.
  destruct r2'; try discriminate.
  destruct (fcmp ctx x arg1 n sb n sb  evm_stack_opm) eqn: fcmp_x_arg1;
    try discriminate.
...
- (* evaluation is preserved *) 
  ...
  + injection Hoptm_sbinding as eq_val' _.
    ...
    destruct r2 as [|x r2']; try discriminate.
    destruct r2'; try discriminate.
    destruct (fcmp ctx x arg2 idx sb idx sb  evm_stack_opm) 
    ...
    pose proof (eval_sstack_val'_extend_sb  maxidx' model mem strg
      ext idx sb sb' evm_stack_opm prefix Hvalid_sb sb_prefix y yv eval_y) 
      as eval_y_sb.
    ...
    pose proof (valid_sstack_value_gt  idx' idx x Hvalid_x
      idx_gt_idx') as Hvalid_x_sb.
    
    pose proof (Hsafe_sstack_val_cmp ctx x arg2 idx sb idx sb 
      evm_stack_opm Hissat Hvalid_x_sb Hvalid_arg2 Hvalid_sb Hvalid_sb fcmp_x_arg2
      model mem strg ext Hismodel) as [xv' [eval_x' eval_arg2']].
  ...
  + destruct (is_sub_x arg2 arg1 fcmp idx  sb evm_stack_opm) 
    ...
    destruct r2 as [|x r2']; try discriminate.
    destruct r2'; try discriminate.
    destruct (fcmp ctx x arg1 idx sb idx sb  evm_stack_opm) 
    ...
    pose proof (Hsafe_sstack_val_cmp ctx x arg1 idx sb idx sb 
      evm_stack_opm Hissat Hvalid_x_sb Hvalid_arg1 Hvalid_sb Hvalid_sb fcmp_x_arg1
      model mem strg ext Hismodel) as [xv' [eval_x' eval_arg1']].
    unfold eval_sstack_val in eval_x'.
