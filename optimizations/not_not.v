...
- (* evaluation is preserved *) 
  intros stk mem strg ext v Hismodel Heval_orig.
  unfold optimize_not_not_sbinding in Hoptm_sbinding.
  ...
  simpl in Heval_orig.
  destruct (eval_sstack_val' maxidx arg1 stk mem strg ext idx sb evm_stack_opm)
  ...
  simpl in eq_eval_arg1_sb.
  destruct (eval_sstack_val' maxidx' arg2 stk mem strg ext idx1 sb1 
  ...
  pose proof (eval_sstack_val'_extend_sb_indep idx 
    (S (S maxidx')) stk mem strg ext idx1 (S maxidx') sb sb1 evm_stack_opm
