...
| Some (FollowSmapVal (SymOp AND [arg1; arg2]) idx' sb') => 
      if fcmp ctx x arg1 maxid sb idx' sb' ops then 
        Some arg2
      else if fcmp ctx x arg2 maxid sb idx' sb' ops then 
        Some arg1
      else None
| _ => None
end.
...
match val with
| SymOp AND [arg1;arg2] =>
  match is_and arg1 arg2 fcmp maxid sb ops ctx with
  | Some y => (SymOp AND [arg1;y], true)
  | None => 
    match is_and arg2 arg1 fcmp maxid sb ops ctx with
...
destruct (is_and arg1 arg2 fcmp n sb evm_stack_opm ctx) 
  as [y|] eqn: eq_is_and.
- unfold is_and in eq_is_and.
  ...
  + destruct (fcmp ctx arg1 arg22 n sb idx' sb' evm_stack_opm)
    ...
    * (* arg1 ~ arg22 *)
      ...
      simpl. unfold valid_stack_op_instr. simpl. intuition.
- destruct (is_and arg2 arg1 fcmp n sb evm_stack_opm) 
  ...
  + (* arg2 ~ arg11 *)
    ...
    simpl. unfold valid_stack_op_instr. simpl. intuition.
  + destruct (fcmp ctx arg2 arg12 n sb idx' sb' evm_stack_opm)
...
- (* evaluation is preserved *) 
  ...
  destruct r1 as [|arg2 r2]; try inject_rw Hoptm_sbinding eq_val'.
  destruct r2 as [|arg3 r3]; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_and arg1 arg2 fcmp idx sb evm_stack_opm ctx) 
    as [y|] eqn: eq_is_and.
  + injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
    ...
    * (* arg1 ~ arg21 *)
      ...
      destruct (eval_sstack_val' idx arg22 model mem strg ext idx' sb' 
      ...
      pose proof (eval_sstack_val'_extend_sb idx model mem strg
        ext idx sb sb' evm_stack_opm prefix Hvalid_sb eq_prefix arg22 arg22v
    ...
    * destruct (fcmp ctx arg1 arg22 idx sb idx' sb' evm_stack_opm)
        eqn: eq_fcmp_arg1_arg22; try discriminate.
      (* arg1 ~ arg22 *)
      unfold eval_sstack_val in Heval_orig.
      unfold eval_sstack_val.
      ...
      apply follow_suffix in eq_follow_arg2 as [prefix eq_prefix].
      pose proof (eval_sstack_val'_extend_sb idx model mem strg
        ext idx sb sb' evm_stack_opm prefix Hvalid_sb eq_prefix arg21 arg21v
  ...
  + destruct (is_and arg2 arg1 fcmp idx sb evm_stack_opm ctx) 
      as [y|] eqn: eq_is_and'; try inject_rw Hoptm_sbinding eq_val'.
    injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
    ...
    * (* arg2 ~ arg11 *)
      ...
      destruct (eval_sstack_val' idx arg12 model mem strg ext idx' sb' 
      ...
      pose proof (eval_sstack_val'_extend_sb idx model mem strg
        ext idx sb sb' evm_stack_opm prefix Hvalid_sb eq_prefix arg12 arg12v
    ...
    * destruct (fcmp ctx arg2 arg12 idx sb idx' sb' evm_stack_opm)
        eqn: eq_fcmp_arg2_arg12; try discriminate.
      (* arg2 ~ arg12 *)
      unfold eval_sstack_val in Heval_orig.
      unfold eval_sstack_val.
      ...
      apply follow_suffix in eq_follow_arg1 as [prefix eq_prefix].
      pose proof (eval_sstack_val'_extend_sb idx model mem strg
        ext idx sb sb' evm_stack_opm prefix Hvalid_sb eq_prefix arg11 arg11v
