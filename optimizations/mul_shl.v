...
match val with
| SymOp MUL [arg1;arg2] => 
  match is_shl_1 arg1 fcmp maxid sb ops ctx with
  | Some x => (SymOp SHL [x; arg2], true)
  | None => match is_shl_1 arg2 fcmp maxid sb ops ctx with
...
destruct (is_shl_1 arg1 fcmp n sb evm_stack_opm) as [x|] eqn: is_shl_arg1.
- injection Hoptm_sbinding as eq_val' _.
  ...
  destruct (fcmp ctx onev (Val WOne) n sb n sb evm_stack_opm) eqn: fcmp_onev;
    try discriminate.
  ...
  simpl. 
  intuition.
- destruct (is_shl_1 arg2 fcmp n sb evm_stack_opm) as [y|] eqn: is_shl_arg2;
    try inject_rw Hoptm_sbinding eq_val'.
  injection Hoptm_sbinding as eq_val' _.
  rewrite <- eq_val'.
...
- (* evaluation is preserved *) 
  ...
  destruct r1 as [|arg2 r2]; try inject_rw Hoptm_sbinding eq_val'.
  destruct r2; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_shl_1 arg1 fcmp idx sb evm_stack_opm) 
  ...
  + injection Hoptm_sbinding as eq_val' _.
    ...
    destruct r2 as [|onev r2']; try discriminate.
    destruct r2'; try discriminate.
    destruct (fcmp ctx onev (Val WOne) idx sb idx sb evm_stack_opm) eqn: fcmp_onev;
      try discriminate.
    ...
    destruct (eval_sstack_val' maxidx' xx model mem strg ext idx' sb'
      evm_stack_opm) as [xxv|] eqn: eval_xx_sb'; try discriminate.
    destruct (eval_sstack_val' maxidx' onev model mem strg ext idx' sb'
    ...
    pose proof (valid_sstack_value_gt idx' idx onev Hvalid_onev
    ...
    reflexivity.
  + destruct (is_shl_1 arg2 fcmp idx sb evm_stack_opm) as [y|] 
    ...
    destruct r2 as [|onev r2']; try discriminate.
    destruct r2'; try discriminate.
    destruct (fcmp ctx onev (Val WOne) idx sb idx sb evm_stack_opm) 
    ...
    destruct (eval_sstack_val' maxidx' yy model mem strg ext idx' sb'
    ...
    pose proof (eval_sstack_val'_extend_sb maxidx' model mem strg
      ext idx sb sb' evm_stack_opm prefix Hvalid_sb sb_prefix y yyv
