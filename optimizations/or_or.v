...
fun (ops: stack_op_instr_map) =>
  ...
  match val with
  | SymOp OR [arg1;arg2] =>
      match is_or arg1 arg2 fcmp maxid  sb ops ctx with
      | Some y => (SymOp OR [arg1;y], true)
      | None => 
          match is_or arg2 arg1 fcmp maxid  sb ops ctx with
...
destruct (is_or arg1 arg2 fcmp n  sb evm_stack_opm) 
  as [y|] eqn: eq_is_or.
- unfold is_or in eq_is_or.
  ...
  + destruct (fcmp ctx arg1 arg22 n sb idx' sb'  evm_stack_opm)
    ...
    * (* arg1 ~ arg22 *)
      ...
      simpl. unfold valid_stack_op_instr. simpl. intuition.
- destruct (is_or arg2 arg1 fcmp n  sb evm_stack_opm) 
...
- (* evaluation is preserved *) 
  ...
  destruct (is_or arg1 arg2 fcmp idx  sb evm_stack_opm) 
    as [y|] eqn: eq_is_or.
  + injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
  ...
  + destruct (is_or arg2 arg1 fcmp idx  sb evm_stack_opm) 
      as [y|] eqn: eq_is_or'; try inject_rw Hoptm_sbinding eq_val'.
    injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
