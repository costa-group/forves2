...
| Some (FollowSmapVal (SymOp GT [arg1; arg2]) idx' sb') => 
    if fcmp ctx arg2 (Val WZero) maxid sb maxid sb ops
    then Some arg1
    else None
| _ => None
end.
...
match val with
| SymOp ISZERO [arg] => 
  match is_gt_zero arg fcmp maxid sb ops ctx with
...
destruct (is_gt_zero arg1 fcmp n sb evm_stack_opm ctx) as [x|] 
  eqn: is_gt_zero_arg1.
...
- (* evaluation is preserved *) 
  ...
  destruct args as [|arg1 r1] eqn: eq_args; 
    try inject_rw Hoptm_sbinding eq_val'.
  destruct r1; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_gt_zero arg1 fcmp idx sb evm_stack_opm ctx) 
  ...
  + injection Hoptm_sbinding as eq_val' _.
    ...
    pose proof (iszero_gt_zero_snd ext xxv) as H. simpl in H.
