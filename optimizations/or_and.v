...
destruct (is_and arg1 arg2 fcmp n  sb evm_stack_opm) 
  as [y|] eqn: eq_is_and.
...
- (* evaluation is preserved *) 
  ...
  destruct r1 as [|arg2 r2]; try inject_rw Hoptm_sbinding eq_val'.
  destruct r2 as [|arg3 r3]; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_and arg1 arg2 fcmp idx  sb evm_stack_opm) 
    as [y|] eqn: eq_is_and.
  + injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
  ...
  + destruct (is_and arg2 arg1 fcmp idx  sb evm_stack_opm) 
      as [y|] eqn: eq_is_and'; try inject_rw Hoptm_sbinding eq_val'.
    injection Hoptm_sbinding as eq_val' _.
    rewrite <- eq_val'.
