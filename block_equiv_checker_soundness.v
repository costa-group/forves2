...
Proof.
  ...
  destruct (mk_tools_1 tools maxid) eqn:E_tools_1.

  simpl in H_evm_eq_block_chkr'.
    
  remember (apply_opt_n_times_pipeline_k opt_pipeline sstack_val_cmp opt_step_rep opt_pipeline_rep) as opt.
  ...
  pose proof (apply_opt_n_times_pipeline_k_snd opt_pipeline sstack_val_cmp opt_step_rep opt_pipeline_rep H_sstack_val_cmp_snd) as H_safe_opt.
