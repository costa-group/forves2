...
Proof.
  ...
  assert( H_valid_u1_u2_smem: valid_smemory maxidx (U_MSTORE sstack_val soffset svalue :: U_MSTORE sstack_val soffset' svalue' :: smem)). simpl. auto.  
  pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops (U_MSTORE sstack_val soffset svalue :: U_MSTORE sstack_val soffset' svalue' :: smem) H_valid_u1_u2_smem H_valid_bs (gt_Sn_n maxidx) H_is_model) as H_map_o_smem_0.
  destruct H_map_o_smem_0 as [u1_u2_smem_v H_map_o_smem_0].
  rewrite H_map_o_smem_0.

  assert( H_valid_u1_smem: valid_smemory maxidx (U_MSTORE sstack_val soffset svalue ::  smem)). simpl. auto.  
  pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops (U_MSTORE sstack_val soffset svalue :: smem) H_valid_u1_smem H_valid_bs (gt_Sn_n maxidx) H_is_model) as H_map_o_smem_1.
  destruct H_map_o_smem_1 as [u1_smem_v H_map_o_smem_1].
  rewrite H_map_o_smem_1.

  pose proof (map_option_split_2 (memory_update sstack_val)  (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' (S maxidx) sv model mem strg exts maxidx bs ops)) smem u1_u2_smem_v (U_MSTORE sstack_val soffset svalue) (U_MSTORE sstack_val soffset' svalue') H_map_o_smem_0) as H_map_o_smem_0_0.
  ...
  pose proof (map_option_split (memory_update sstack_val)  (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' (S maxidx) sv model mem strg exts maxidx bs ops)) smem u1_smem_v (U_MSTORE sstack_val soffset svalue) H_map_o_smem_1) as H_map_o_smem_1_0.
...
Proof. 
  ...
  assert( H_valid_u1_u2_smem: valid_smemory maxidx (U_MSTORE8 sstack_val soffset svalue :: U_MSTORE8 sstack_val soffset' svalue' :: smem)). simpl. auto.  
  pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops (U_MSTORE8 sstack_val soffset svalue :: U_MSTORE8 sstack_val soffset' svalue' :: smem) H_valid_u1_u2_smem H_valid_bs (gt_Sn_n maxidx) H_is_model) as H_map_o_smem_0.
  destruct H_map_o_smem_0 as [u1_u2_smem_v H_map_o_smem_0].
  rewrite H_map_o_smem_0.

  assert( H_valid_u1_smem: valid_smemory maxidx (U_MSTORE8 sstack_val soffset svalue ::  smem)). simpl. auto.  
  pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops (U_MSTORE8 sstack_val soffset svalue :: smem) H_valid_u1_smem H_valid_bs (gt_Sn_n maxidx) H_is_model) as H_map_o_smem_1.
  destruct H_map_o_smem_1 as [u1_smem_v H_map_o_smem_1].
  rewrite H_map_o_smem_1.

  pose proof (map_option_split_2 (memory_update sstack_val)  (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' (S maxidx) sv model mem strg exts maxidx bs ops)) smem u1_u2_smem_v (U_MSTORE8 sstack_val soffset svalue) (U_MSTORE8 sstack_val soffset' svalue') H_map_o_smem_0) as H_map_o_smem_0_0.
  destruct H_map_o_smem_0_0 as [u1_v [u2_v [smem_v [H_u1_u2_smem_v [H_map_o_smem_0_u1 [H_map_o_smem_0_u2 H_map_o_smem_0_smem]]]]]].
  ...
  pose proof (map_option_split (memory_update sstack_val)  (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' (S maxidx) sv model mem strg exts maxidx bs ops)) smem u1_smem_v (U_MSTORE8 sstack_val soffset svalue) H_map_o_smem_1) as H_map_o_smem_1_0.
  destruct H_map_o_smem_1_0 as [u1_v' [smem_v' [H_u1_smem_v' [H_map_o_smem_1_u1 H_map_o_smem_1_smem]]]].
...
Proof.
  ...
  assert( H_valid_u1_u2_smem: valid_smemory maxidx (U_MSTORE sstack_val soffset' svalue' :: U_MSTORE8 sstack_val soffset svalue :: smem)). simpl. auto.  
  pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops (U_MSTORE sstack_val soffset' svalue' :: U_MSTORE8 sstack_val soffset svalue :: smem) H_valid_u1_u2_smem H_valid_bs (gt_Sn_n maxidx) H_is_model) as H_map_o_smem_0.
  destruct H_map_o_smem_0 as [u1_u2_smem_v H_map_o_smem_0].
  rewrite H_map_o_smem_0.
...
Lemma basic_mload_solver_snd: mload_solver_ext_snd basic_mload_solver.
  ...
  + exists idx1. exists m1.
    ...
    ++ simpl in H_basic_mload_solver.
       ...
       apply H_add_to_smap.
    ++ intros model mem strg exts H_stk_len.
       simpl in H_basic_mload_solver.
       rewrite <- H_basic_mload_solver in H_add_to_smap.
       ...
       pose proof (eval_sstack_val'_succ (S maxidx) soffset model mem strg exts maxidx bs ops H_valid_soffset H_valid_smap (gt_Sn_n maxidx)) as H_eval_soffset.
  ...
  + unfold basic_mload_solver in H_basic_mload_solver.
    ...
    ++ destruct (sstack_val_cmp (S (get_maxidx_smap m)) ctx soffset soffset' (get_maxidx_smap m) (get_bindings_smap m) (get_maxidx_smap m) (get_bindings_smap m) ops) eqn:E_cmp_soffset_soffset'.
       +++ rewrite <- H_basic_mload_solver in H_add_to_smap.
           ...
           simpl in H_add_to_smap.
             ...
             pose proof (eval_sstack_val'_immediate_fresh_var (S (S maxidx)) maxidx model mem strg exts svalue bs ops) as H_eval_fresh_maxidx_0.
             rewrite  H_eval_fresh_maxidx_0.

             simpl in H_valid_smem.
             destruct H_valid_smem as [[H_valid_soffset' H_valid_svalue] H_valid_smem'].

             pose proof (eval_sstack_val'_succ (S maxidx) svalue model mem strg exts maxidx bs ops H_valid_svalue H_valid_smap (gt_Sn_n maxidx)) as H_eval_svalue.
             destruct H_eval_svalue as [svalue_v H_eval_svalue].
             
             pose proof (eval_sstack_val'_preserved_when_depth_extended (S maxidx) maxidx bs svalue svalue_v model mem strg exts ops H_eval_svalue) as H_eval_svalue_bis.
             ...
             pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx bs ops smem' H_valid_smem' H_valid_smap (gt_Sn_n maxidx) H_is_model) as H_mo_1.
             ...
             reflexivity.
       +++ destruct (memory_slots_do_not_overlap ctx soffset soffset' 31 31) eqn:E_not_overlap.
           ++++ destruct m as [maxidx sb] eqn:E_m.
                ...
                pose proof (IHsmem'_0 model mem strg exts H_is_model) as IHsmem'_1.
                ...
                pose proof (H_memory_slots_do_not_overlap ctx soffset soffset' 31 31 maxidx sb ops H_valid_smap H_valid_soffset H_valid_soffset' E_not_overlap model mem strg exts H_is_model) as H_memory_slots_do_not_overlap_0.
                destruct H_memory_slots_do_not_overlap_0 as [v1' [v2' [H_eval_soffset_bis [H_eval_soffset' H_not_overlap]]]].
                rewrite HeqS_maxidx.
                
                rewrite H_eval_soffset'.
                pose proof (eval_sstack_val'_succ (S maxidx) svalue model mem strg exts maxidx sb ops H_valid_svalue H_valid_smap (gt_Sn_n maxidx)) as H_eval_svalue.
                destruct H_eval_svalue as [svalue_v H_eval_svalue].
                rewrite H_eval_svalue.

                pose proof (H_map_o_smem ctx (S maxidx) model mem strg exts maxidx sb ops smem' H_valid_smem' H_valid_smap (gt_Sn_n maxidx) H_is_model) as H_mo_1.
                destruct H_mo_1 as [v''' H_mo_1].
                rewrite H_mo_1.
                ...
                simpl in H_eval_fresh_var_maxidx.
                destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' S_maxidx sv model mem strg exts maxidx sb ops)) smem') as [smem_updates|] eqn:E_mo_1; try discriminate.
           ...
           ++++ destruct m as [maxidx sb] eqn:E_m. 
                ...
                assert(H_valid_freshvar_maxidx: valid_sstack_value S_maxidx (FreshVar maxidx)).
                  (* proof of assert *)
                   simpl.
                   rewrite HeqS_maxidx.
                   apply lt_n_Sn.

               assert(H_valid_ex_bs: valid_bindings S_maxidx ((maxidx, SymMLOAD soffset (U_MSTORE sstack_val soffset' svalue :: smem')) :: sb) ops).
                   (* proof of assert *)
                   rewrite HeqS_maxidx.
                   simpl.
                   split; try auto.
                   ...
                   pose proof (eval_sstack_val'_succ (S S_maxidx) (FreshVar maxidx) model mem strg exts S_maxidx ((maxidx, SymMLOAD soffset (U_MSTORE sstack_val soffset' svalue :: smem')) :: sb) ops H_valid_freshvar_maxidx H_valid_ex_bs (gt_Sn_n S_maxidx)) as H_eval_freshvar_maxidx.
    ...
    ++ destruct (memory_slots_do_not_overlap ctx soffset soffset' 31 0) eqn:E_not_overlap.
       +++ destruct m as [maxidx sb] eqn:E_m.
          simpl in H_valid_smem.
          destruct H_valid_smem as [[H_valid_soffset' H_valid_svalue] H_valid_smem'].
          ...
          pose proof (H_memory_slots_do_not_overlap ctx soffset soffset' 31 0 maxidx sb ops H_valid_smap H_valid_soffset H_valid_soffset' E_not_overlap model mem strg exts H_is_model) as H_memory_slots_do_not_overlap_0.
          destruct H_memory_slots_do_not_overlap_0 as [v1' [v2' [H_eval_soffset_bis [H_eval_soffset' H_not_overlap]]]].
          rewrite HeqS_maxidx.
       ...
       +++ destruct m as [maxidx sb] eqn:E_m. 
          ...
          assert(H_valid_ex_bs: valid_bindings S_maxidx ((maxidx, SymMLOAD soffset (U_MSTORE8 sstack_val soffset' svalue :: smem')) :: sb) ops).
            (* proof of assert *)
            rewrite HeqS_maxidx.
            simpl.
            split; try auto.
            ...
            pose proof (eval_sstack_val'_succ (S S_maxidx) (FreshVar maxidx) model mem strg exts S_maxidx ((maxidx, SymMLOAD soffset (U_MSTORE8 sstack_val soffset' svalue :: smem')) :: sb) ops H_valid_freshvar_maxidx H_valid_ex_bs (gt_Sn_n S_maxidx)) as H_eval_freshvar_maxidx.
            destruct H_eval_freshvar_maxidx as [v H_eval_freshvar_maxidx].
            exists v.
            split; apply H_eval_freshvar_maxidx.
Qed.
  ...
  Lemma basic_smemory_updater_remove_mstore_dups_valid:
    forall sstack_val_cmp ctx soffset m ops smem smem_r,
      ...
      basic_smemory_updater_remove_mstore_dups sstack_val_cmp ctx soffset smem m ops = smem_r ->
      valid_smemory (get_maxidx_smap m) smem_r.
  Proof.
  ...
  Qed.
    ...
    forall sstack_val_cmp ctx soffset m ops smem smem_r,
      ...
      valid_sstack_value (get_maxidx_smap m) soffset ->
      valid_smemory (get_maxidx_smap m) smem ->
      basic_smemory_updater_remove_mstore8_dups sstack_val_cmp ctx soffset smem m ops = smem_r ->
      valid_smemory (get_maxidx_smap m) smem_r.
  Proof.
    intros sstack_val_cmp ctx soffset m ops.
    induction smem as [| u smem' IHsmem'].
  ...
  Lemma basic_smemory_updater_remove_dups_correct_eq_key:
    forall sstack_val_cmp ctx soffset svalue model mem strg exts m ops smem1 smem2 mem1 mem2 v,
      ...
      valid_smemory (get_maxidx_smap m) smem1 ->
      valid_smemory (get_maxidx_smap m) smem2 ->
      eval_smemory (U_MSTORE sstack_val soffset svalue :: smem1) (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops = Some mem1 ->
      eval_smemory (U_MSTORE sstack_val soffset svalue :: smem2) (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops = Some mem2 ->
      eval_sstack_val' (S (get_maxidx_smap m)) soffset model mem strg exts (get_maxidx_smap m)  (get_bindings_smap m) ops = Some v ->
  ...
  Proof.
    ...
    destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) (U_MSTORE sstack_val soffset svalue :: smem2)) as [updates2|] eqn:E_mo_2; try discriminate.
    injection H_eval_smem2 as H_mem2.
    

    pose proof (map_option_split (memory_update sstack_val) (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem1 updates1 (U_MSTORE sstack_val soffset svalue) E_mo_1) as E_mo_1_0.
    destruct E_mo_1_0 as [e1 [updates1' [E_updates1 [E_e1 H_mo_1_0]]]].

    pose proof (map_option_split (memory_update sstack_val) (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem2 updates2 (U_MSTORE sstack_val soffset svalue) E_mo_2) as E_mo_2_0.
    ...
    destruct (eval_sstack_val' (S (get_maxidx_smap m)) svalue model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops) as [svalue_v|] eqn:H_eval_svalue; try discriminate.
  ...
  Qed.
    ...
    forall sstack_val_cmp ctx soffset svalue model mem strg exts m ops,
      ...
      basic_smemory_updater_remove_mstore_dups sstack_val_cmp ctx soffset smem m ops = smem_r ->
      exists mem1 mem2,
        eval_smemory (U_MSTORE sstack_val soffset svalue :: smem) (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops =
          Some mem1 /\
          eval_smemory (U_MSTORE sstack_val soffset svalue :: smem_r) (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops = Some mem2 /\
    ...
    Proof.
      ...
      + intros smem_r H_valid_smem H_basic_mstore_up.
        ...
        assert(H_valid_u: valid_smemory (get_maxidx_smap m)  [U_MSTORE sstack_val soffset svalue]). simpl. auto.
        pose proof (eval_smemory_succ (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops [U_MSTORE sstack_val soffset svalue] H_valid_u H_valid_smap) as H_eval_u.
      ...
      + intros smem_r H_valid_smem H_basic_mstore_up.
        ...
        ++ simpl in H_valid_smem.
           ...
           +++ rewrite <- H_basic_mstore_up. 
               ...
               remember (basic_smemory_updater_remove_mstore_dups sstack_val_cmp ctx soffset smem' m ops) as smem'_r.
               ...
               pose proof (eval_sstack_val'_succ (S (get_maxidx_smap m)) soffset model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops H_valid_soffset H_valid_smap (gt_Sn_n ((get_maxidx_smap m)))) as H_eval_soffset.
               destruct H_eval_soffset as [soffset_v H_eval_soffset].
               
               pose proof (eval_sstack_val'_succ (S (get_maxidx_smap m)) soffset' model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops H_valid_soffset' H_valid_smap (gt_Sn_n ((get_maxidx_smap m)))) as H_eval_soffset'.
               destruct H_eval_soffset' as [soffset'_v H_eval_soffset'].

               pose proof (eval_sstack_val'_succ (S (get_maxidx_smap m)) svalue model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops H_valid_svalue H_valid_smap (gt_Sn_n ((get_maxidx_smap m)))) as H_eval_svalue.
               ...
               destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val'  (S (get_maxidx_smap m)) sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) (U_MSTORE sstack_val soffset svalue :: smem')) as [updates1|] eqn:E_mo_1; try discriminate.
               pose proof (map_option_split (memory_update sstack_val) (memory_update EVMWord) (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val' (S (get_maxidx_smap m)) sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) smem' updates1 (U_MSTORE sstack_val soffset svalue) E_mo_1) as E_mo_1_split.
               ...
               destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val'  (S (get_maxidx_smap m)) sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) (U_MSTORE sstack_val soffset svalue :: smem'_r)) as [updates2|] eqn:E_mo_2; try discriminate.
        ...
        ++ simpl in H_valid_smem.
           destruct H_valid_smem as [ [H_valid_soffset' H_valid_svalue'] H_valid_smem'].
           destruct (mstore8_is_included_in_mstore sstack_val_cmp ctx soffset' soffset) eqn:E_mstore8_inc.
           +++ pose proof (IHsmem' smem_r H_valid_smem' H_basic_mstore_up) as IHsmem'_0.
               destruct IHsmem'_0 as [mem1' [mem2' [IHsmem'_0_1 [IHsmem'_0_2 IHsmem'_0_3]]]].
...
Qed.
    ...
    Lemma basic_smemory_updater_remove_mstore8_dups_correct:
      forall sstack_val_cmp ctx soffset svalue model mem strg exts m ops,
        ...
        forall smem smem',
          valid_smemory (get_maxidx_smap m) smem ->
          basic_smemory_updater_remove_mstore8_dups sstack_val_cmp ctx soffset smem m ops = smem' ->
          exists mem1 mem2,
            eval_smemory (U_MSTORE8 sstack_val soffset svalue :: smem) (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops =
          Some mem1 /\
              eval_smemory (U_MSTORE8 sstack_val soffset svalue :: smem') (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops = Some mem2 /\
              forall w, mem1 w = mem2 w.
    Proof.
      intros sstack_val_cmp ctx soffset svalue model mem strg exts m ops.
      intros H_sstack_val_cmp_snd H_is_model H_valid_soffset H_valid_svalue H_valid_smap.
      ...
      + intros smem_r H_valid_smem H_basic_mstore_up.
        ...
        rewrite <- H_basic_mstore_up.
        assert(H_valid_u: valid_smemory (get_maxidx_smap m)  [U_MSTORE sstack_val soffset svalue]). simpl. auto.
        pose proof (eval_smemory_succ (get_maxidx_smap m) (get_bindings_smap m) model mem strg exts ops [U_MSTORE8 sstack_val soffset svalue] H_valid_u H_valid_smap) as H_eval_u.
        destruct H_eval_u as [smem' H_eval_u].
        rewrite H_eval_u.
        exists smem'.
        exists smem'.
      ...
      + intros smem_r H_valid_smem H_basic_mstore_up.
        ...
        ++ simpl in H_valid_smem.
           ...
           remember (basic_smemory_updater_remove_mstore8_dups sstack_val_cmp ctx soffset smem' m ops) as smem'_r.
           rewrite Heqsmem'_r in *.
           symmetry in Heqsmem'_r.
           rewrite Heqsmem'_r.
           ...
           destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val'  (S (get_maxidx_smap m)) sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) (U_MSTORE8 sstack_val soffset svalue :: smem')) as [updates1|] eqn:E_mo_1; try discriminate.
           ...
           unfold eval_smemory in H_eval_u_smem'_r.
           unfold eval_sstack_val in  H_eval_u_smem'_r.
           destruct (map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val'  (S (get_maxidx_smap m)) sv model mem strg exts (get_maxidx_smap m) (get_bindings_smap m) ops)) (U_MSTORE8 sstack_val soffset svalue :: smem'_r)) as [updates2|] eqn:E_mo_2; try discriminate.
